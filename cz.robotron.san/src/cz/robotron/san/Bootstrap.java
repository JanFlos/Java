...
public class Bootstrap {
        ...
        SQLException
    {
        ...
        _master.addDetailDataBlock(_detail, "sid = :sid");
    }
    ...
    private MPart createDummyPart(String label) {
        MPart part = _modelService.createModelElement(MPart.class);
        part.setLabel(label);
        return part;
    ...
    void createAplicationModel(MApplication application) throws SQLException {
        ...
        /*
         * masterStack.getChildren().add(createDummyPart("second part"));
        detailStack.getChildren().add(createDummyPart("fourth part"));
         */
