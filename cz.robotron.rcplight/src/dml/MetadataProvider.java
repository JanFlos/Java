...
import cz.robotron.rcplight.DataBlockColumn;
import cz.robotron.rcplight.QueryDataSource;
...
public class MetadataProvider {
                            ...
                            List<String> primaryKeyColumns)
    {
        ...
        _insertableColumnNames = IterableUtils.difference(tableColumns, readOnlyColumns);
        ...
        _updateableColumnsNames = IterableUtils.difference(_insertableColumnNames, _primaryKeyColumnsNames);
    ...
    public MetadataProvider(Connection connection, QueryDataSource queryDataSource) throws SQLException {
        ...
        if (_dmlTargetTableName != null) {
            ...
            _readOnlyColumnNames = IterableUtils.difference(_allColumnNames, _insertableColumnNames);
