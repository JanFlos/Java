...
public class Snippet048TreeViewerTabWithCheckboxFor3_3 {
    public Snippet048TreeViewerTabWithCheckboxFor3_3(final Shell shell) {
        int a = SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL;
        FilteredTree fv = new FilteredTree(shell, a, new PatternFilter(), true);
        //final TreeViewer v = new TreeViewer(shell, SWT.BORDER | SWT.FULL_SELECTION);
        final TreeViewer v = fv.getViewer();
        ...
        v.getControl().addTraverseListener(new TraverseListener() {
            ...
            public void keyTraversed(TraverseEvent e) {
                    ...
                    && mgr.getFocusCell().getColumnIndex() == 2)
                {
                    ...
                    try {
                        Method m =
                            ColumnViewerEditor.class.getDeclaredMethod("processTraverseEvent", new Class[] { int.class, ViewerRow.class,
                                TraverseEvent.class });
